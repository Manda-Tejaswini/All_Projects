...
public  static  String  encodeHtmlTag(String  tag)  { 
	if (tag==null)
		...
		for(int  i =  0  ; i <  length;i++)  {
		char  c =  tag.charAt(i); if(c=='<') encodedTag.append("<"); else  if(c=='>') encodedTag.append(">"); else  if(c=='&')
		encodedTag.append("&amp;"); else  if(c=='"') encodedTag.append("&quot;"); else  if(c=='"') encodedTag.append("&nbsp;"); else
		encodedTag.append(c);
		}
